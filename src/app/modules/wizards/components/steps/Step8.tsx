...
const Step8: FC = () => {
  ...
  return (
        ...
        <div className='col-lg-12'>
          ...
          >
            ...
            <span className='d-block fw-bold text-start'>
              ...
              <hr />
              <a href={data.ifeurl3} target="_blank">{data.ifeurl3}</a>
            </span>
          </label>
          <input
            type='file'
    ...
    <div className='fv-row mb-10 mt-3'>
      ...
      <input type="text" name='namefull3' className='form-control form-control-lg form-control-solid'  defaultValue={data.namefull3} />
