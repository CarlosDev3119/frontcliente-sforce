  ...
  return (
    ...
    >
      ...
      <div className='text-center mb-11'>
        ...
        <div className='text-gray-500 fw-semibold fs-6'>Comienza de inmediato con SFORCE</div>
      </div>
      {/* begin::Heading */}
      ...
      {formik.status ? (
        ...
        <div className='mb-10 bg-light-info p-8 rounded'>
          ...
          Utiliza la cuenta <strong>admin@demo.com</strong> y la contraseña <strong>demo</strong> para continuar.
          </div>
        </div>
      )}
